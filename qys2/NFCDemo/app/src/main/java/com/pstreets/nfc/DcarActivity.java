...
public class DcarActivity extends AppCompatActivity {
    //油品下的车辆列表
                ...
                try
                {
                    ...
                    if(code.equals("200")){
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            String cs=value.getString("bw_all_call_count");
                            // String title = value.optString("title");
                            list.add(new Good((i+1) +"  "+ name+"  "+title+"  "+cs+"次", false,by_code));
                        }
...
//        }
        ...
        progressDialog = ProgressDialog.show(DcarActivity.this, "请稍等...", "获取数据中...", true);
        new Thread() {
            @Override
            public void run() {

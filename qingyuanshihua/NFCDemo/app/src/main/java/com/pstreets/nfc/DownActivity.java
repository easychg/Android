...
public class DownActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    //油品信息
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //填充数据
        //putData();
        progressDialog = ProgressDialog.show(DownActivity.this, "请稍等...", "获取数据中...", true);
        new Thread() {
            @Override
            public void run() {
